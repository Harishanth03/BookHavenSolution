...
namespace BookHaven {
    ...
    public partial class BookDataSet : global::System.Data.DataSet {
        ...
        public partial class BookDataTable : global::System.Data.TypedTableBase<BookRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BookRow AddBookRow(string Title, string Author, string ISBN, string Genre, decimal Price, int StockQuantity) {
...
namespace BookHaven.BookDataSetTableAdapters {
    ...
    public partial class BookTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Book] WHERE (([BookID] = @Original_BookID) AND ([Title] = @Original_Title) AND ([Author] = @Original_Author) AND ([ISBN] = @Original_ISBN) AND ([Genre] = @Original_Genre) AND ([Price] = @Original_Price) AND ([StockQuantity] = @Original_StockQuantity))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Book] ([Title], [Author], [ISBN], [Genre], [Price], [StockQuantity]) VALUES (@Title, @Author, @ISBN, @Genre, @Price, @StockQuantity);
SELECT BookID, Title, Author, ISBN, Genre, Price, StockQuantity FROM Book WHERE (BookID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Book] SET [Title] = @Title, [Author] = @Author, [ISBN] = @ISBN, [Genre] = @Genre, [Price] = @Price, [StockQuantity] = @StockQuantity WHERE (([BookID] = @Original_BookID) AND ([Title] = @Original_Title) AND ([Author] = @Original_Author) AND ([ISBN] = @Original_ISBN) AND ([Genre] = @Original_Genre) AND ([Price] = @Original_Price) AND ([StockQuantity] = @Original_StockQuantity));
SELECT BookID, Title, Author, ISBN, Genre, Price, StockQuantity FROM Book WHERE (BookID = @BookID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT BookID, Title, Author, ISBN, Genre, Price, StockQuantity FROM dbo.Book";
        ...
        public virtual int Delete(int Original_BookID, string Original_Title, string Original_Author, string Original_ISBN, string Original_Genre, decimal Original_Price, int Original_StockQuantity) {
            ...
            this.Adapter.DeleteCommand.Parameters[6].Value = ((int)(Original_StockQuantity));
        ...
        public virtual int Insert(string Title, string Author, string ISBN, string Genre, decimal Price, int StockQuantity) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, string Author, string ISBN, string Genre, decimal Price, int StockQuantity, int Original_BookID, string Original_Title, string Original_Author, string Original_ISBN, string Original_Genre, decimal Original_Price, int Original_StockQuantity, int BookID) {
            if ((Title == null)) {
                throw new global::System.ArgumentNullException("Title");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Author, string ISBN, string Genre, decimal Price, int StockQuantity, int Original_BookID, string Original_Title, string Original_Author, string Original_ISBN, string Original_Genre, decimal Original_Price, int Original_StockQuantity) {
            return this.Update(Title, Author, ISBN, Genre, Price, StockQuantity, Original_BookID, Original_Title, Original_Author, Original_ISBN, Original_Genre, Original_Price, Original_StockQuantity, Original_BookID);
        }
    }
